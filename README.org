...
#+begin_src sh
bash <( curl -fsSL "https://raw.githubusercontent.com/nik312123/testy/master/install_mac_requirements.sh" )
#+end_src
...
#+begin_src sh
bash <( curl -fsSL "https://raw.githubusercontent.com/nik312123/testy/master/install_mac_requirements.sh" ) -v
#+end_src
