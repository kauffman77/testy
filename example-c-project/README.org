...
demonstrate failed tests and show how they look (see the [[correct-version][section on
...
* <<correct-version>> Compiling the "Correct" Version of the Stack Application
